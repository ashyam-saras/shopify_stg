...
from (
    ...
    discount_applications.* {{exclude()}}(target_type, type, value_type),
    coalesce(discount_applications.target_type, 'N/A') as target_type,
    coalesce(discount_applications.type, 'N/A') as type,
    coalesce(discount_applications.value_type, 'N/A') as value_type,
